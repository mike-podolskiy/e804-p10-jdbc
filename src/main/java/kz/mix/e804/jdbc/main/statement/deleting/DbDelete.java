//CHECKSTYLE:OFF
package kz.mix.e804.jdbc.main.statement.deleting;
        ...
        try (Connection connection = DbConnector.connectToDb();
            ...
            try (ResultSet resultSet2 = statement.executeQuery("SELECT * FROM contact")) {
                ...
                while (resultSet2.next()) {
                    System.out.println(resultSet2.getInt("id") + "\t" + resultSet2.getString("firstName") + "\t" + resultSet2.getString("lastName") + "\t"
                            + resultSet2.getString("email") + "\t" + resultSet2.getString("phoneNo"));
                }
            }
